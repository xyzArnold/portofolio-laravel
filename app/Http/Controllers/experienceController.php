...
class experienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        riwayat::create($data);
        return redirect()->route('experience.index')->with('success', 'Anjay berhasil tambah data experience');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('experience.index')->with('success', 'Anjay berhasil update data');
    }
