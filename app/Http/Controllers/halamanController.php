...
class halamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        halaman::create($data);
        return redirect()->route('halaman.index')->with('success', 'Anjay berhasil tambah data');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Anjay berhasil update data');
    }
