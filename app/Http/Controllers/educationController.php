...
class educationController extends Controller
{
    ...
    {
        $data = riwayat::where('tipe', $this->_tipe)->orderBy('judul', 'asc')->get();
    ...
    public function store(Request $request)
    {
        ...
        riwayat::create($data);
        return redirect()->route('education.index')->with('success', 'Anjay berhasil tambah data education');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Anjay berhasil edit data education');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Anjay berhasil delete data');
    }
}